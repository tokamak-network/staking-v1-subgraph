...
export function handleStaked (event: StakedEvent): void {
  ...
  if (candidate == null) candidate = new Candidate(event.params.candidateIndex.toString())
  ...
  let stake = new Staked(transaction.id + '#' + txCount.toString())
...
export function handleRestaked (event: RestakedEvent): void {
  ...
  // tx update
  let transaction = loadTransaction(event)
  let restake = new Restaked(transaction.id + '#' + candidate.txCount.toString())
...
export function handleUnstaked (event: UnstakedEvent): void {
  ...
  // tx update
  let transaction = loadTransaction(event)
  let unstake = new Unstaked(transaction.id + '#' + candidate.txCount.toString())
...
export function handleWithdrawal (event: WithdrawalEvent): void {
  ...
  // tx update
  let transaction = loadTransaction(event)
  let withdraw = new Withdrawal(transaction.id + '#' + candidate.txCount.toString())
